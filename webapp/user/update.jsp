        ...
        <div class="panel panel-default content-main">
            <form name="question" method="post" action="/user/update">
                <div class="form-group">
                    ...
                    <input class="form-control" id="userId" value=${user.userId} name="userId" placeholder="User ID">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success clearfix pull-right">수정 내용 저장</button>
                <div class="clearfix" />
            </form>
        </div>
    </div>
